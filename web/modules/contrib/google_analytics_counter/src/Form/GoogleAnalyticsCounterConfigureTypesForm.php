...
/**
 * The form for editing content types.
 *
 * Editing content types with the custom Google Analytics counter field.
 *
 * @internal
 */
class GoogleAnalyticsCounterConfigureTypesForm extends ConfigFormBase {
   ...
   * {@inheritdoc}
   */
  public function __construct(ConfigFactoryInterface $config_factory, MessengerInterface $messenger, GoogleAnalyticsCounterAppManagerInterface $app_manager, GoogleAnalyticsCounterCustomFieldGeneratorInterface $custom_field, EntityTypeManagerInterface $entity_type_manager) {
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $options = NULL) {
    ...
    // Add a checkbox to determine whether the storage
    // for the custom field should be removed.
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    // Add/subtract the custom field or do nothing.
    foreach ($values as $key => $value) {
      ...
      elseif ($values['gac_type_remove_storage'] == FALSE && $value == 0) {
